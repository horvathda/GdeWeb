...
namespace GdeWebDB.Services
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<LoginResultModel> LoginWithGoogle(string email, string name, string picture)
        {
            // Google "name" → teljes név, szét kell bontani
            string firstName = "";
            string lastName = "";
            ...
            if (user == null)
            {
                ...
                user = new User
                {
                    ...
                    FIRSTNAME = firstName,
                    LASTNAME = lastName,
                    ACTIVE = true  // Google auth után aktív legyen
                };
            ...
            // LoginResultModel összeállítása
            var result = new LoginResultModel
            {
                Id = user.USERID,
                Active = user.ACTIVE,
                Roles = new List<LoginRoleModel>(),   // Ha van jogosultságkezelés, itt kell betölteni
