...
namespace GdeWeb.Services
{
    public class CustomAuthentication : AuthenticationStateProvider
    {
        ...
        /// <summary>
        /// Felhasználó autentikálttá jelölése (klasszikus login: LoginResultModel-ből)
        /// </summary>
        ...
        /// <summary>
        /// Felhasználó autentikálttá jelölése nyers JWT token alapján
        /// (pl. Google OAuth callback után)
        /// </summary>
